...
in a slot ends the replay — `Expected the resume to render <X> in this slot
but instead it rendered <Y>` — and every hole falls back to client rendering,
which arrives as a page whose buttons do nothing.
