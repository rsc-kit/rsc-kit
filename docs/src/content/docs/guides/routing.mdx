...
| A shell | Something was still waiting when the budget expired, but the chrome had already painted. The shell is stored; the rest is rendered per request and streamed in. |
