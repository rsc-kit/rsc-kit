...
[about 400 lines of PHP](/hosts/laravel); Go's is
[about the same](https://github.com/rsc-kit/rsc-kit/tree/main/adapters/go).
...
Reference implementations: [Laravel](/hosts/laravel), and
[Go](https://github.com/rsc-kit/rsc-kit/tree/main/adapters/go).
