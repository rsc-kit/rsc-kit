  ...
  return (
    <main>
      ...
      <section className="hero">
        <p className="eyebrow">React Server Components as a Vite plugin · v0.18</p>
        <h1>
      ...
      <Section n="07" label="Honest" title="Where it stands">
        <p>
          Version 0.18, and the API is not frozen. For a content site with forms on Bun or Workers, it is ready
